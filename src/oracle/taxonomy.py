    ...
    Category(
        ...
        subcategories=[
            ...
            Subcategory(
                ...
                description="Commercial and registry-level domain blocking mechanisms.",
                topics=[
                    Topic(
                        name="DPML (Domains Protected Marks List)",
                        description="Donuts' block service across new gTLD portfolio.",
                        key_concepts=["DPML", "Donuts/Identity Digital", "block", "block+", "overrides"],
                    ),
                    Topic(
                        name="AdultBlock",
                        description="Blocking in adult-content TLDs (.xxx, .porn, .sex, .adult).",
                        key_concepts=["AdultBlock", ".xxx", ".porn", ".sex", ".adult", "ICM Registry"],
                    ),
                    Topic(
                        name="GlobalBlock (Consolidated Blocking Service)",
                        description="Cross-registry blocking service proposal and implementations.",
                        key_concepts=["GlobalBlock", "consolidated blocking", "cross-registry", "ICANN RPMs"],
                    ),
                    Topic(
                        name="Registry lock services",
                        description="Server-side lock requiring manual intervention, protection against hijacking.",
                        key_concepts=["registry lock", "serverDeleteProhibited", "serverTransferProhibited", "serverUpdateProhibited"],
                    ),
                ],
            ),
            Subcategory(
